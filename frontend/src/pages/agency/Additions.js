...
class Additions extends Component {
  ...
  getAdditions = async (pageNumber) => {
    try {
      ...
      //   null
      // );
      const response = await api_axios("get", `/additions`, null);
      if (this._isMounted) {
  ...
  submitForm = async () => {
    try {
      if (this._isMounted) {
        ...
        const response = await api_axios("post", `/additions`, newAddition);
        this.toggle();
                ...
                <>
                  ...
                  >
                    <Pagination
                      ...
                      onChange={(pageNumber) => this.getAdditions(pageNumber)}
                      itemClass="page-item"
                      linkClass="page-link"
                      firstPageText="First"
                      lastPageText="Last"
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    deleteAddition: (addition) => dispatch(actions.deleteAddition(addition)),
    addAddition: (addition) => dispatch(actions.addAddition(addition)),
    getCurrencies: (currencies) => dispatch(actions.getCurrencies(currencies)),
  };
};
