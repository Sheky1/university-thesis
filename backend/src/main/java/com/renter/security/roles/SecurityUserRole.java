...
public enum SecurityUserRole implements SecurityUserRoleInterface {
    ...
    AGENCY(Sets.newHashSet(VEHICLE_READ, VEHICLE_WRITE, FUEL_TYPE_READ, FUEL_TYPE_WRITE, VEHICLE_SIZE_READ, VEHICLE_SIZE_WRITE, ADDITION_READ, ADDITION_WRITE, CURRENCY_READ)),
