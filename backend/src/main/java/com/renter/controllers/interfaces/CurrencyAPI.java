...
public interface CurrencyAPI {
    ...
    @Operation(summary = "Create currency", description = "This endpoint is for creating a new currency object. ", tags = "Currencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update currency", description = "This endpoint is for updating a specific currency object. ", tags = "Currencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete currency", description = "This endpoint is for deleting a currency object. ", tags = "Currencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get currencies", description = "This endpoint is for getting all available currencies with pagination.", tags = "Currencies")
    ...
    @Operation(summary = "Get currencies", description = "This endpoint is for getting all available currencies.", tags = "Currencies")
    @ApiResponse(responseCode = "200", description = "All currencies found",
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(implementation = CurrencyDto.class))})
    List<CurrencyDto> getAllCurrencies();

    @Operation(summary = "Get currency", description = "This endpoint is for getting specific currency object. ", tags = "Currencies")
    @ApiResponses(value = {
