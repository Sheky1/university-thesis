...
public interface AgencyAPI {
    ...
    @Operation(summary = "Create agency", description = "This endpoint is for creating a new agency object. ", tags = "Agencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Update agency", description = "This endpoint is for updating a specific agency object. ", tags = "Agencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Delete agency", description = "This endpoint is for deleting a agency object. ", tags = "Agencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get agencies", description = "This endpoint is for getting all available agencies with pagination.", tags = "Agencies")
    ...
    @Operation(summary = "Get agencies", description = "This endpoint is for getting all available agencies.", tags = "Agencies")
    @ApiResponse(responseCode = "200", description = "All agencies found",
            content = {@Content(mediaType = "application/json",
                    schema = @Schema(implementation = AgencyDto.class))})
    List<AgencyDto> getAllAgencies();

    @Operation(summary = "Get agency", description = "This endpoint is for getting specific agency object. ", tags = "Agencies")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get vehicles", description = "This endpoint is for getting specific agency object. ", tags = "Agencies")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Agency successfully found",
                    content = {@Content(mediaType = "application/json",
                            schema = @Schema(implementation = AgencyDto.class))}),
